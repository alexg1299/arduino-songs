...
char notes[] = "cacbcbg gedcbcbg cacbcbg aafagagC"; // a space represents a rest

// Beats is an array values for each note and rest.
// A "1" represents a quarter-note, 2 a half-note, etc.
// Don't forget that the rests (spaces) need a length as well.

int beats[] = {1,2,1,2,1,2,3, 1,1,1,2,1,2,1,2,3, 1,1,2,1,2,1,2,3, 1,1,1,2,1,2,1,2,3};
...
int frequency(char note) 
{
  ...
  char names[] = { 'e', 'd', 'c', 'b', 'a', 'g', 'f', 'C' };
  int frequencies[] = {1319, 1175, 1047, 988, 880, 784, 698, 523};
